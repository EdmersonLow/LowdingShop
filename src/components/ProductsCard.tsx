...
export const ProductsCard = ({product}) => {
  ...
  return (
    <div className="w-full relative group">
      <div onClick={handleDetails} className="w-full h-96 px-3 cursor-pointer overflow-hidden">
        <img 
      ...
      <div className='w-full border-[1px] px-2 py-4'>
        ...
        <div className='flex gap-2 justify-end relative overflow-hidden w-28 text-sm'>
         <div className='w-28 flex justify-end gap-2 relative text-sm group-hover:translate-x-24 transition-transform duration-500' >
